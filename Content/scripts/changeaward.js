...
function myFunctionMM(rate, fee) {
    ...
    if (val >= 50000) {
        $.ajax({
            ...
            success: function (e) {
                if (e.Code == 1) {
					if (e.Data.Coin > 0 && e.Data.Bonus > 0) {
                        $("#frmMM #xu-mm").html(e.Data.Coin.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " + " + e.Data.Bonus.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                    }
					else if (e.Data.Coin > 0) {
                        $("#frmMM #xu-mm").html(e.Data.Coin.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                    }
					else {
    ...
    if (val >= 50000) {
        $.ajax({
            ...
            success: function (e) {
                if (e.Code == 1) {
					if (e.Data.Coin > 0 && e.Data.Bonus > 0) {
                        $("#frmBB #xu-bb").html(e.Data.Coin.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") + " + " + e.Data.Bonus.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                    }
					else if (e.Data.Coin > 0) {
                        $("#frmBB #xu-bb").html(e.Data.Coin.toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
                    }
					else {
						$("#frmBB #xu-bb").html(Math.floor((val * rate * fee) * 10).toString().replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,"));
					}
