...
(function (PIXI) {
    ...
    PIXI.MultiObserver = MultiObserver;
    /**
    ...
    var Observable = /** @class */ (function () {
         ...
         */
        Observable.prototype.add = function (callback, scope, mask, insertFirst, unregisterOnFirstCall) {
            if (mask === void 0) {
                mask = -1;
            }
         ...
         * @returns the new observer created for the callback
         */
        Observable.prototype.addOnce = function (callback, scope, mask, insertFirst) {
            return this.add(callback, scope, mask, insertFirst, true);
        };
        /**
